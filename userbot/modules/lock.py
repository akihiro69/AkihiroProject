...
CMD_HELP.update(
    {
        ...
        \n  ❍▸ : **Memungkinkan anda Mengunci beberapa jenis pesan dalam obrolan.\
        \n\n  𝘾𝙤𝙢𝙢𝙖𝙣𝙙 :** `{cmd}unlock` <all atau Jenis lock>\
        \n  ❍▸ : **Untuk membuka kunci, beberapa jenis pesan dalam obrolan.\
